const template = [
  ...
  { name: 'Bag', url: '/bag/:from', fields: [{ name: 'From', field: 'from' }] },
  {
    name: 'Ballmer',
  ...
  { name: 'Bye', url: '/bye/:from', fields: [{ name: 'From', field: 'from' }] },
  {
    name: 'Can I Use',
  ...
  { name: 'Cup', url: '/cup/:from', fields: [{ name: 'From', field: 'from' }] },
  {
    name: 'Dalton',
  ...
  { name: 'No', url: '/no/:from', fields: [{ name: 'From', field: 'from' }] },
  {
    name: 'Nugget',
  ...
  { name: 'Too', url: '/too/:from', fields: [{ name: 'From', field: 'from' }] },
  {
    name: 'Tucker',
    url: '/tucker/:from',
    fields: [{ name: 'From', field: 'from' }],
